...
from states import GET_CITY, EDIT_SEX, PROFILE, EDIT_SEARCH_SEX
...
async def update_search_sex(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'sex_male':
        ...
        context.user_data['looking_for'] = 'Все'
    await update_user_field(update.effective_user.id, 'looking_for', context.user_data['looking_for'])
